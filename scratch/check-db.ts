...
async function check() {
  ...
  if (settings) {
    console.log("Settings doc:", JSON.stringify(settings, null, 2));
    console.log("Email raw length:", settings.email.length);
    console.log("Email charCodes:", [...settings.email].map(c => c.charCodeAt(0)));
  } else {
